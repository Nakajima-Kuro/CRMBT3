...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE users SET name=(:name), email=(:email), gender=(:gender), mobile=(:mobile), position=(:position), Image=(:image) WHERE id=(:idedit)";
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data" name="imgform">
												<div class="form-group">
													<label class="col-sm-2 control-label">Họ tên<span style="color:red">*</span></label>
													<div class="col-sm-4">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<select name="gender" class="form-control" required>
															...
															<option value="male" 	<?php echo $result->gender == "male" ? "selected" : "" ?>>Nam</option>
															<option value="female" 	<?php echo $result->gender == "female" ? "selected" : ""?>>Nữ</option>
														...
														<select name="position" class="form-control" required>
															...
															if ($query->rowCount() > 0) {
																foreach ($results as $i) {
																	if ($i->id != $result->position) {
															?>
																		<option value="<?php echo htmlentities($i->id); ?>">
																			<?php echo htmlentities($i->name); ?>
																		</option>
																	<?php
																	} else {
																		?>
																		<option value="<?php echo htmlentities($i->id); ?>" selected>
																			<?php echo htmlentities($i->name); ?>
																		</option>
																		<?php
																	}
