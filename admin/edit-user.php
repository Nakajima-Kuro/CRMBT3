...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "UPDATE users SET name=(:name), email=(:email), gender=(:gender), mobile=(:mobile), position_id=(:position), Image=(:image) WHERE id=(:idedit)";
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<select name="gender" class="form-control" required>
															...
															<option value="Nam" 	<?php echo $result->gender == "Nam" ? "selected" : "" ?>>Nam</option>
															<option value="Nữ" 	<?php echo $result->gender == "Nữ" ? "selected" : ""?>>Nữ</option>
